...
void test_WriteACK() {
    ...
    std::unique_ptr<TitaniumPackage> package = std::make_unique<TitaniumPackage>(address,
                                                                                 WRITE_SECURE_COMMAND,
                                                                                 MOCK_AREA_INDEX,
