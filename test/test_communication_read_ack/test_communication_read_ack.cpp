...
void test_ReadACK() {
    ...
    std::unique_ptr<TitaniumPackage> package = std::make_unique<TitaniumPackage>(address, READ_SECURE_COMMAND, MOCK_AREA_INDEX, connection_status_proto);
