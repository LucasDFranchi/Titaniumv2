...
class MemoryArea {
   public:
     ...
     */
    esp_err_t Clear(void) { return memset_s(this->data, 0, this->size); }
    /**
     * Retrieves the size of the memory area.
     *
     * @returns The size of the memory area.
     */
    uint32_t GetSize(void) { return this->size; }
     ...
     */
    access_type_e GetAccess(void) { return this->access_type; }
     ...
     */
    area_index_e GetAreaIndex(void) { return this->index; }
     ...
     */
    bool GetAreaHasUpdated(void) { return this->has_update; }
     ...
     *
     * @returns ESP_OK if the write operation is successful, otherwise an error
     * code.
     */
    ...
    /**
     * Reads the contents of the MemoryAreaDisplay object into the provided
     * buffer.
     *
     * @param data_pointer Pointer to the buffer where the data will be copied
     * to.
     *
