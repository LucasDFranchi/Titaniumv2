...
def generate_cpp_header(board):
    ...
    if has_spi_configured:
        header_content.append(f"    static constexpr spi_host_device_t SPI_HOST = SPI{board['spi_pins']['spi_host']}_HOST;")
        ...
        header_content.append(f"    static constexpr gpio_num_t SPI_CS = GPIO_NUM_{board['spi_pins']['cs']};\n")
